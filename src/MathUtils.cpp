 ...
 * Позволяет эффективно отсекать одиночные импульсные помехи ("выбросы"),
 * не затрачивая много ресурсов CPU.
 */
 ...
 * Показывает реальное содержание водяного пара в воздухе вне зависимости от температуры.
 * @param temp Температура в градусах Цельсия
 * @param rh Относительная влажность в процентах (0-100)
 */
 ...
 * Точка росы — это температура, до которой должен охладиться воздух,
 * чтобы содержащийся в нем пар достиг состояния насыщения и начал конденсироваться.
 */
